...
MINIO_UPSTREAM_HOST=127.0.0.1
MINIO_UPSTREAM_PORT=9000
EOF
...
sed \
  ...
  -e "s/__MINIO_UPSTREAM_HOST__/${MINIO_UPSTREAM_HOST}/g" \
  -e "s/__MINIO_UPSTREAM_PORT__/${MINIO_UPSTREAM_PORT}/g" \
