...
export const apiEndpoints = {
  ...
  schedules: {
    ...
    displayPreflight: withBase('/schedules/display-preflight'),
  },
  scheduleRequests: {
  ...
  screens: {
    ...
    displayState: withBase('/screens/:id/display-state'),
    displaySelection: withBase('/screens/:id/display-selection'),
  },
  screenGroups: {
