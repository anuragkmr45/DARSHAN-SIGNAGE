...
For curl-by-curl request and response examples, use [`DEVICE_PAIRING_API_FLOW_WITH_CURLS.md`](/Users/anuragkumar/Desktop/darshan/darshan-server/docs/DEVICE_PAIRING_API_FLOW_WITH_CURLS.md).

Primary code references:
- [`src/routes/device-pairing.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts)
- [`src/middleware/device-auth.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/middleware/device-auth.ts)
- [`src/routes/device-telemetry.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts)
- [`src/routes/screens.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/screens.ts)
- [`src/screens/playback.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/screens/playback.ts)
- [`src/routes/schedules.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/schedules.ts)
- [`src/routes/schedule-requests.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/schedule-requests.ts)
- [`src/routes/schedule-publish-helper.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/schedule-publish-helper.ts)
- [`src/routes/emergency.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/emergency.ts)
- [`src/routes/media.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/media.ts)
- [`src/config/apiEndpoints.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/config/apiEndpoints.ts)
- [`src/server/index.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/server/index.ts)
- [`src/index.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/index.ts)
...
- The repo docs mention a separate mTLS device server on `DEVICE_PORT`, but current runtime starts only one Fastify server on `PORT`. See [`src/index.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/index.ts).
- Current device auth is header-based certificate identity, not transport-level TLS client-certificate verification. `authenticateDeviceOrThrow` checks `x-device-serial`/`x-device-cert-serial`/`x-device-cert` against `device_certificates.serial`. See [`src/middleware/device-auth.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/middleware/device-auth.ts).
- Pairing response returns `expires_at` for the issued certificate, and current device auth enforces certificate expiry in addition to `is_revoked` / `revoked_at`. See [`src/routes/device-pairing.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts) and [`src/middleware/device-auth.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/middleware/device-auth.ts).
...
Actual derivation lives in [`src/screens/playback.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/screens/playback.ts).
...
- [`docs/DESKTOP_PLAYER_INTEGRATION.md`](/Users/anuragkumar/Desktop/darshan/darshan-server/docs/DESKTOP_PLAYER_INTEGRATION.md)
...
- enforce certificate expiry in [`src/middleware/device-auth.ts`](/Users/anuragkumar/Desktop/darshan/darshan-server/src/middleware/device-auth.ts)
