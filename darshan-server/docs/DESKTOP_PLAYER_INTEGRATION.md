...
- /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts
- /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts
- /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/screens.ts
- /Users/anuragkumar/Desktop/darshan/darshan-server/src/utils/default-media.ts
- docs/contracts/device-player-guide.md
...
- Device snapshot endpoint allows either:
  ...
  Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts authenticateDeviceSnapshot.
...
- Config defines `DEVICE_PORT=8443` but server listens only on `PORT` (default 3000). Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/config/index.ts, /Users/anuragkumar/Desktop/darshan/darshan-server/src/index.ts.
...
- Side effects: creates `device_pairings` row. Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts fastify.post(apiEndpoints.devicePairing.request)

### 1.2 Admin confirms pairing (CMS)
- `POST /api/v1/device-pairing/confirm` with JWT
- Body: `{ pairing_code, name, location? }`
- Side effects: marks the pairing as confirmed and stores screen metadata for the upcoming completion step. It does **not** create the `screens` row yet. Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts fastify.post(apiEndpoints.devicePairing.confirm)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts fastify.post(apiEndpoints.devicePairing.complete)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts fastify.get(apiEndpoints.deviceTelemetry.snapshot)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts filterItemsForScreen + snapshot response.

## 4) Media URLs + caching strategy

- If `include_urls=true`, response includes `media_urls` map keyed by `media_id`.
- URLs are presigned for 3600 seconds. Ref: `getPresignedUrl(..., 3600)` in /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts.
- Caching guidance:
  ...
  - Persist last successful snapshot on disk for offline fallback (`docs/contracts/device-player-guide.md`).

## 5) Polling + refresh strategy (recommended)

- Snapshot refresh: every 30-60s (`docs/contracts/device-player-guide.md` suggests 60s). Use `publish.published_at` to detect changes.
- Commands refresh: every ~15s (`docs/contracts/device-player-guide.md` suggests 15s) OR piggyback on heartbeat response.
- Offline behavior:
...
- Ref: docs/contracts/device-player-guide.md
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts fastify.post(apiEndpoints.deviceTelemetry.heartbeat)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts createCommandSchema + commands endpoints.
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts fastify.post(apiEndpoints.deviceTelemetry.proofOfPlay)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts fastify.post(apiEndpoints.deviceTelemetry.screenshot)
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/utils/default-media.ts and /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-telemetry.ts snapshot handler.
...
- Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/utils/app-error.ts, /Users/anuragkumar/Desktop/darshan/darshan-server/src/routes/device-pairing.ts
...
JWT expiry note (CMS only): `JWT_EXPIRY` is seconds (default 900). Ref: /Users/anuragkumar/Desktop/darshan/darshan-server/src/config/index.ts.
