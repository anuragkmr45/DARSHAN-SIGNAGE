...
## Backend gates
Run from [`darshan-server`](/Users/anuragkumar/Desktop/darshan/darshan-server):
```bash
npm run build
...
## CMS gates
Run from [`darshan-cms`](/Users/anuragkumar/Desktop/darshan/darshan-cms):
```bash
npm run build
```
...
## Player gates
Run from [`darshan-player`](/Users/anuragkumar/Desktop/darshan/darshan-player):
```bash
npm run build
```
