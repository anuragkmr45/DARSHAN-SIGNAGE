...
Only set `DARSHAN_WEBPAGE_CAPTURE_EXECUTABLE_PATH` if Chromium lives outside the standard Playwright-managed location. `HEXMON_WEBPAGE_CAPTURE_EXECUTABLE_PATH` remains a legacy alias for one release.
