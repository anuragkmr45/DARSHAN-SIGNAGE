...
- backend selector: `DARSHAN_CONFIG_FILE=/etc/darshan/server/config.production.json`.
...
- backend direct-host: `DARSHAN_CONFIG_FILE=/etc/darshan/server/config.production.json`.
