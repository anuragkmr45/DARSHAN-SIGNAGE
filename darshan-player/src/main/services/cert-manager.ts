...
export class CertificateManager {
  ...
  private createCSR(
    ...
    const subject = [
      { name: 'commonName', value: overrides.commonName || deviceInfo.deviceId || deviceInfo.hostname || 'darshan-device' },
      { name: 'organizationName', value: overrides.organization || 'DARSHAN' },
