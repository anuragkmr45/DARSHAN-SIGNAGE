# Contributing to DARSHAN Player

Thank you for your interest in contributing to the DARSHAN Player! This document provides guidelines and instructions for contributing.
...
3. Add upstream remote:
   ```bash
   git remote add upstream https://github.com/darshan/signage-player.git
   ```
...
- GitHub Discussions
- Discord: https://discord.gg/darshan
- Email: dev@darshan.com
