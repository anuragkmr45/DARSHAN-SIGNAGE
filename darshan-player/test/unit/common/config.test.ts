...
describe('Config Manager', () => {
  ...
  afterEach(() => {
    ...
    if (originalDARSHANApiBase === undefined) {
      delete process.env.HEXMON_API_BASE
    } else {
      process.env.HEXMON_API_BASE = originalDARSHANApiBase
    }
    if (originalDARSHANWsUrl === undefined) {
      delete process.env.HEXMON_WS_URL
    } else {
      process.env.HEXMON_WS_URL = originalDARSHANWsUrl
    }
  ...
  describe('Configuration Loading', () => {
    it('should load configuration from file', () => {
      ...
      expect(config.apiBase).to.equal('https://api-test.darshan.com')
  ...
  describe('Environment Variable Overrides', () => {
    ...
    it('should prefer DARSHAN_RUNTIME_MODE over the legacy HEXMON_RUNTIME_MODE alias', () => {
      process.env.DARSHAN_RUNTIME_MODE = 'qa'
      process.env.HEXMON_RUNTIME_MODE = 'production'
