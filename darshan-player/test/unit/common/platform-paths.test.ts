...
describe('platform-paths', () => {
  ...
  beforeEach(() => {
    ...
    originalEnv = {
      ...
      DARSHAN_CONFIG_PATH: process.env.DARSHAN_CONFIG_PATH,
      DARSHAN_CACHE_PATH: process.env.DARSHAN_CACHE_PATH,
      DARSHAN_MTLS_CERT_DIR: process.env.DARSHAN_MTLS_CERT_DIR,
    ...
    delete process.env.DARSHAN_CACHE_PATH
    delete process.env.DARSHAN_MTLS_CERT_DIR
  ...
  it('resolves runtime paths from DARSHAN_RUNTIME_ROOT', () => {
  ...
  it('keeps HEXMON_RUNTIME_ROOT as a legacy alias', () => {
