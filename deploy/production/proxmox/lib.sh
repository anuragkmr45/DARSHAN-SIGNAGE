...
load_production_env() {
  ...
  export DATA_CT_ID="${DATA_CT_ID:-100}"
  export BACKEND_CT_ID="${BACKEND_CT_ID:-101}"
  export CMS_CT_ID="${CMS_CT_ID:-102}"
  export VALKEY_CT_ID="${VALKEY_CT_ID:-103}"
  export OBSERVABILITY_CT_ID="${OBSERVABILITY_CT_ID:-104}"

  export DATA_HOST="${DATA_HOST:-192.168.1.100}"
  export BACKEND_HOST="${BACKEND_HOST:-192.168.1.101}"
  export CMS_HOST="${CMS_HOST:-192.168.1.102}"
  export VALKEY_HOST="${VALKEY_HOST:-192.168.1.103}"
  export OBSERVABILITY_HOST="${OBSERVABILITY_HOST:-192.168.1.104}"
  ...
  export PROMETHEUS_UPSTREAM_URL="${PROMETHEUS_UPSTREAM_URL:-http://127.0.0.1:${PROMETHEUS_PORT}}"
