...
It contains source-controlled templates and reusable assets consumed by development, QA, and production Docker deployments:

- CMS nginx default template references,
...
- QA Docker-on-VM validation,
- production Docker-on-VM deployments.
